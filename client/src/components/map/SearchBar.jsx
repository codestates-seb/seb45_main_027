...
const SearchBar = ({
  ...
  return (
    <form
      ...
      <div className="flex justify-start bg-white p-2 w-full h-1/8 text-center mr-4 my-5 shadow-xl rounded-lg">
        <img
      ...
      <button
        className="shadow-xl rounded-lg bg-white w-[50px]  my-4"
