...
const Sidebar = () => {
    ...
    return (
    <div className="flex flex-col w-max h-0 sticky top-48 float-right mr-20">
      ...
      <button className={display} onClick={() => setBookmark(!Bookmark)}>
        <img
          className="m-4"
          src={Bookmark ? "/images/bookmark-on.png" : "/images/bookmark-off.png"}
          alt="북마크"
        />
      </button>
      ...
      <button className={display}>
        <img className="m-5" src="/images/side-speech-bubble.png" alt="댓글" />
      </button>
