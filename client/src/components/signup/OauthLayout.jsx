...
const OauthLayout = ({ path }) => {
 ...
 // console.log("Code from URL:", code);//확인용 추후 삭제
  ...
  return (
    <div className="w-[320px] md:w-[380px] flex justify-center px-[10%]">
      <button className="w-full bg-[#FFEB00] hover:bg-[#FFEB00a8] flex justify-center py-2.5 rounded-lg items-center mr-2">
        <svg
          viewBox="0 0 48 48"
        ...
        <span className="font-bold text-xl text-[#3C2929]">Kakao</span>
      </button>

      <button className="w-full bg-[#00C63B] hover:bg-[#00c63ba8] flex justify-center py-2.5 rounded-lg items-center ml-2">
        <svg
          viewBox="0 0 48 48"
          preserveAspectRatio="xMidYMid meet"
          className="w-12 h-12"
        ...
        <span className="font-bold text-xl text-[#FFF]">Naver</span>
      </button>
    </div>
  );
};
