package com.project.bbibbi.global.exception.exceptionhandler;
...
import com.project.bbibbi.global.exception.businessexception.requestexception.RequestContentTypeException;
import com.project.bbibbi.global.exception.businessexception.requestexception.RequestTypeException;
...
public class RestControllerAdvice {
    ...
    public ResponseEntity<ApiSingleResponse<Void>> handleTypeMismatchException(
        ...
        return new ResponseEntity<>(ApiSingleResponse.fail(new RequestTypeException(stringValue)), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ApiSingleResponse<Void>> handleHttpMessageConversionException(
        ...
        return new ResponseEntity<>(ApiSingleResponse.fail(new RequestTypeException()), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ApiSingleResponse<Void>> handleHttpMediaTypeNotSupportedException (
        ...
        return new ResponseEntity<>(ApiSingleResponse.fail(new RequestContentTypeException(contentType)), HttpStatus.BAD_REQUEST);
    }
