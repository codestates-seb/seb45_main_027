package com.project.bbibbi.auth.oauth.dto;
...
public class OAuthAttributes {
     ...
     * 소셜별 of 메소드(ofKaKao, ofNaver)들은 각각 소셜 로그인 API에서 제공하는
    ...
    public static OAuthAttributes of(SocialType socialType,
        ...
        if (socialType == SocialType.NAVER) {
            ...
            throw new IllegalArgumentException("지원하지 않는 SocialType입니다: " + socialType);
        }
    }
